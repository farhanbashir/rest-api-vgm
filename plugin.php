...
if ( ! class_exists( 'WP_REST_Test_Controller' ) ) {
	require_once dirname( __FILE__ ) . '/lib/endpoints/class-wp-rest-test-controller.php';
}

if ( ! class_exists( 'WP_REST_Mixer_Controller' ) ) {
	require_once dirname( __FILE__ ) . '/lib/endpoints/class-wp-rest-mixer-controller.php';
}

if ( ! class_exists( 'WP_REST_Cron_Controller' ) ) {
	require_once dirname( __FILE__ ) . '/lib/endpoints/class-wp-rest-cron-controller.php';
}
...
if ( ! function_exists( 'create_initial_rest_routes' ) ) {
	...
	function create_initial_rest_routes() {
		...
		// Mixer controllers.
		$controller = new WP_REST_Mixer_Controller();
		$controller->register_routes();
        ...
        // Cron.
        $controller = new WP_REST_Cron_Controller;
        $controller->register_routes();
